...
void *usuarios(void *conector)
{
       ...
       int code,borrador,aceptacion,jugador,jugada,resultado_partida,ganador,hack;
       int nchar;
       static char buf[MAX];
       //char mensaje2[MAX];
       int resultado;
	      ...
	      case 2:
		     ...
		     if(resultado==0){
              ...
              case 4:
                     ...
                     */
                     strcpy(PLAYER.nombre1,invitante);
                     strcpy(PLAYER.nombre2,invitado);
                     pon_player (&PLAYERLIST,PLAYER);
                     //CONTADOR++;
                     printf("******O VALOR DA LISTA EH : %s E %s****** \n",PLAYERLIST.jugadores[1].nombre1,PLAYERLIST.jugadores[1].nombre2);
                     //strcpy(PLAYER.nombre2,invitado); 
                     //pon_player (&PLAYERLIST,PLAYER);   
                     
                     int index = buscar(invitado,mi_lista);
                     int socket_invitado = mi_lista.usuarios[index].conexion;
                     sprintf (mensaje_a_cliente,"5 %s %d",invitante,CONTADOR);
              ...
              case 5:
                     ...
                     sscanf (buf,"%d %d %d", &borrador, &aceptacion, &hack);
                     if(aceptacion == 1){
                            ...
                            */
                            //CONTADOR++;
                            printf("****Valor de Hack: %d\n*****",hack);
                            strcpy(invitante,PLAYERLIST.jugadores[hack].nombre1);
                            
                            
                            int index = buscar(invitante,mi_lista);
                            int socket_invitante = mi_lista.usuarios[index].conexion;
                            sprintf (mensaje_a_cliente,"6 1 %d",hack);
                            ...
                            */
                            ...
                            strcpy(invitado,PLAYERLIST.jugadores[hack].nombre2);
                            printf("el nombre del invitado es: %s \n",invitado);
                            index = buscar(invitado,mi_lista);
                            int socket_invitado = mi_lista.usuarios[index].conexion;
                            sprintf (mensaje_a_cliente,"6 0 %d",hack);
                            write(socket_invitado,mensaje_a_cliente,strlen(mensaje_a_cliente));
                        CONTADOR++;    
              ...
              case 6:
                     ...
                     */
                     ...
                     sscanf (buf,"%d %d %d %d", &borrador, &jugador,&jugada,&hack);
                     if(jugador == 0){
                            ...
                            */
                            ...
                            int index = buscar(invitante,mi_lista);
                            int socket_invitante = mi_lista.usuarios[index].conexion;
                            sprintf (mensaje_a_cliente,"7 1 %d %d",jugada,hack);
                            write(socket_invitante,mensaje_a_cliente,strlen(mensaje_a_cliente));
                     }
                     if(jugador == 1){
                            ...
                            */
                            ...
                            index = buscar(invitado,mi_lista);
                            int socket_invitado = mi_lista.usuarios[index].conexion;
                            sprintf (mensaje_a_cliente,"7 0 %d %d",jugada,hack);
                            write(socket_invitado,mensaje_a_cliente,strlen(mensaje_a_cliente));
                     }
              ...
              case 7:
                     ...
                     */
                     ...
                     sscanf (buf,"%d %d %d %d", &borrador,&resultado_partida,&ganador,&hack);
